...
<main id="js-page-content" role="main" class="page-content mt-3">
  <?php echo flash()->display();?>
    ...
    <div class="row" id="js-contacts">
        ...
        <div class="col-xl-4">
            <div id="c_8" class="card border shadow-0 mb-g shadow-sm-hover" data-filter-tags="<?php echo strtolower($user['username']);?>">
                <div class="card-body border-faded border-top-0 border-left-0 border-right-0 rounded-top">
                    <div class="d-flex flex-row align-items-center">
                                <span class="status status-<?= $user['status'];?> mr-3">
                                    <span class="rounded-circle profile-image d-block " style="background-image:url('uploads/<?php hasImage($user['avatar']);?>'); background-size: cover;"></span>
                                </span>
                        <div class="info-card-text flex-1">
                            <a href="/profile<?=$user['user_id']?>" style="color: #0088cc;">
                            ...
                            <a href="javascript:void(0);" class="fs-xl text-truncate text-truncate-lg text-info" data-toggle="dropdown" aria-expanded="false">
                                ...
                                <?php if ($admin||$loggedId==$user['user_id']):?>
                            ...
                            <div class="dropdown-menu">
                                ...
                                <a class="dropdown-item" href="/status<?=$user['user_id']?>">
                                    <i class="fa fa-sun"></i>
                                    Установить статус</a>
                                <a class="dropdown-item" href="/changeAvatar<?= $user['user_id'];?>">
